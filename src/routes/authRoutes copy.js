...
(async () => {
  ...
  usuarios.push(
    { id: 1, nome: 'Administrador', email: 'admin@email.com', senha: adminSenha, role: 'admin' },
    { id: 2, nome: 'Cliente Padrão', email: 'cliente@email.com', senha: clienteSenha, role: 'cliente' }
  );
})();
...
router.post('/login', async (req, res) => {
  ...
  res.json({ msg: 'Login bem-sucedido', token, usuario: { id: usuario.id, nome: usuario.nome, role: usuario.role } });
});
